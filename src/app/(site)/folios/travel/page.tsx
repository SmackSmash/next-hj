...
export default function TravelPage() {
  return (
    <div className='mx-auto flex max-w-4xl flex-col gap-5 md:flex-row md:items-start'>
      <h1 className='sticky top-20 mb-4 max-w-fit border-b-1 border-zinc-900 pb-4 text-5xl font-semibold text-zinc-900 md:order-1 dark:border-zinc-50 dark:text-zinc-50'>
        Travel
      </h1>
